...
public class HSController : MonoBehaviour
{
	...
	private string secretKey = "7701265134782567750278"; // Edit this value and make sure it's the same as the one stored on the server
	string addScoreURL = "www.tilehpouya.com/gamefrain/addscore.php?"; //be sure to add a ? to your url
	string highscoreURL = "www.tilehpouya.com/gamefrain/display.php";
	...
	public void startPostScores(int bestScore)
	{
        uniqueID = SystemInfo.deviceUniqueIdentifier;
        score = bestScore;
        name3 = GameManager.gameManager.userName; //Load From UserName in Save File or Menu
                                                  //name3; //Name + Game Code
	...
	public void updateOnlineHighscoreData()
	{
        ...
        //name3 = "Drag100"; //Load From UserName in Save File or Menu

        //uniqueID = name3; //Name + Game Code
